    ...
    if (items.length === 0) {
        return (
            ...
            >
                ...
                <p className="text-gray-500 dark:text-gray-400 text-lg font-medium">Tidak ada media ditemukan</p>
                <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Coba pilih kategori lain</p>
            </motion.div>
        );
    }
