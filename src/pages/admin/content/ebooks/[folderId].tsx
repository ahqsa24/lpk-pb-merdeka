            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-100 dark:border-zinc-800 shadow-sm overflow-hidden transition-colors">
                <div className="p-6 border-b border-gray-100 dark:border-zinc-800 flex justify-between items-center bg-gray-50/50 dark:bg-zinc-800/50">
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Manage e-books inside this folder.</p>
                    </div>
                    <button
                    ...
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 dark:bg-zinc-800/50 border-b border-gray-200 dark:border-zinc-700">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Title & Desc</th>
                                <th className="px-6 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">File</th>
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-zinc-800">
                            {filteredEbooks.length === 0 ? (
                                ...
                                filteredEbooks.map((ebook) => (
                                    <tr key={ebook.id} className="hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition">
                                        <td className="px-6 py-4">
                                            <div className="w-12 h-16 bg-gray-200 dark:bg-zinc-700 rounded overflow-hidden flex items-center justify-center text-gray-400 relative">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="font-medium text-gray-900 dark:text-white">{ebook.title}</div>
                                            <div className="text-sm text-gray-500 dark:text-gray-400 truncate max-w-xs">{ebook.description}</div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <button
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full border rounded-lg px-3 py-2 focus:ring-2 outline-none bg-white dark:bg-zinc-800 dark:text-white ${errors.file_url ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 dark:border-zinc-700 focus:ring-red-500'}`}
