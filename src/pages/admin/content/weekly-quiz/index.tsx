        ...
        <AdminLayout title="Weekly Quizzes">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-100 dark:border-zinc-800 shadow-sm p-6 transition-colors">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h2 className="text-xl font-bold text-gray-800 dark:text-white">Weekly Quiz Schedule</h2>
                        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Manage weekly quizzes and their schedules.</p>
                    </div>
                    <button
                ...
                {loading ? (
                    <div className="text-center py-12 text-gray-500 dark:text-gray-400">Loading Quizzes...</div>
                ) : (
                    <div className="space-y-4">
                        {filteredQuizzes.length === 0 ? (
                            <div className="py-12 text-center text-gray-500 dark:text-gray-400 border-2 border-dashed border-gray-200 dark:border-zinc-700 rounded-xl">
                                {searchQuery ? 'No quizzes match your search.' : 'No quizzes scheduled. Create one to get started.'}
                            </div>
                        ) : (
                            filteredQuizzes.map(quiz => (
                                <div key={quiz.id} className="group relative bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col md:flex-row justify-between gap-4">
                                    <div className="flex items-start gap-4">
                                        <div className={`p-3 rounded-lg flex items-center justify-center text-xl shrink-0 ${quiz.is_active ? 'bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400' : 'bg-gray-100 dark:bg-zinc-800 text-gray-400 dark:text-gray-500'}`}>
                                            <FaClipboardList />
                                        </div>
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                <h4 className="font-bold text-gray-900 dark:text-white">{quiz.title}</h4>
                                                <span className="text-xs px-2 py-0.5 bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-gray-400 rounded-full">{quiz.category.name}</span>
                                                {!quiz.is_active && <span className="text-xs px-2 py-0.5 bg-red-100 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-full">Inactive</span>}
                                            </div>
                                    ...
                                    <div className="flex items-center gap-2 self-end md:self-center opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button
                                            ...
                                            className="px-3 py-1.5 text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-lg transition"
                                        >
            ...
            {isFormOpen && (
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-lg p-6 animate-in zoom-in duration-200 max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full border rounded-lg px-3 py-2 outline-none bg-white dark:bg-zinc-800 dark:text-white ${errors.title ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 dark:border-zinc-700 focus:ring-red-500 focus:ring-2'}`}
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full border rounded-lg px-3 py-2 outline-none bg-white dark:bg-zinc-800 dark:text-white ${errors.category ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 dark:border-zinc-700 focus:ring-red-500 focus:ring-2'}`}
                                >
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Question Type <span className="text-red-500">*</span></label>
                                <select
                                    required
                                    value={formType}
                                    onChange={e => {
                                    ...
                                    className={`w-full border rounded-lg px-3 py-2 outline-none bg-white dark:bg-zinc-800 dark:text-white ${errors.type ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 dark:border-zinc-700 focus:ring-red-500 focus:ring-2'}`}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full border rounded-lg px-3 py-2 outline-none bg-white dark:bg-zinc-800 dark:text-white ${errors.startDate ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 dark:border-zinc-700 focus:ring-red-500 focus:ring-2'}`}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full border rounded-lg px-3 py-2 outline-none bg-white dark:bg-zinc-800 dark:text-white ${errors.endDate ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 dark:border-zinc-700 focus:ring-red-500 focus:ring-2'}`}
                                    />
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Number of Questions <span className="text-red-500">*</span></label>
                                <input
                                    type="number"
                                    min="1"
                                    ...
                                    className={`w-full border rounded-lg px-3 py-2 focus:ring-2 outline-none bg-white dark:bg-zinc-800 dark:text-white ${errors.questionCount
